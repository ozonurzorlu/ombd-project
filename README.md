...
Gelişmiş Filtreleme (Bonus): Sadece isimle değil; Film, Dizi veya Bölüm bazlı filtreleme seçeneği sunar.

Veri Kalıcılığı (LocalStorage): Kullanıcı sayfayı yenilese dahi yaptığı son arama otomatik olarak yüklenir.
